  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-4 grid grid-cols-1 md:grid-cols-2 gap-10 text-white">
      ...
      <div className="bg-zinc-900 p-6 rounded-sm shadow-lg border border-zinc-800">
        ...
        <label className="block mt-4 font-medium text-gray-300">
          Phone
        </label>
        <input type="text"
          className="bg-black w-full border border-zinc-800 rounded-lg p-4 mb-4 hover:border-orange-500 transition "
        />
        <label className="block mt-4 font-medium text-gray-300">
          Note
        </label>
